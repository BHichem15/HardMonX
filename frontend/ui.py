...
class SystemMonitorApp:
    def __init__(self, root):
        ...
        # JSON file path
        self.data_file = os.path.join(os.path.dirname(os.path.dirname(__file__)), "backend", "data.json")
    ...
    def update_ui_from_json(self):
        # reading the data from data.json and showing it in the frontend 
        try:
            ...
            print(f"Error: data.json file not found at {self.data_file}.")
